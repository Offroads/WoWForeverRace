...
describe("Core", function()
    ...
    describe("PlayerIdentity", function()
        it("takes our full name the way /who and the roster report it", function()
            local name, realm = WoWForeverRace.Core.PlayerIdentity()
            assert.equals("Nub Nubson", name)
            assert.equals("NubVille", realm)
        end)

        it("is what the addon calls us", function()
            core = WoWForeverRace.Core(config, WoWForeverRace.Core.PlayerIdentity())
            assert.equals("Nub Nubson", core:Me())
            assert.equals("Nub Nubson", core:RealMe())
            assert.equals("NubVille", core:MyRealm())
            assert.equals("Nub Nubson-NubVille", core:FullRealMe())
        end)
    end)
